  ...
  return (
    <div className="auth">
      ...
      <div className="auth__inputs">
        <Input title="Username" width={400} error={warnings.username} setValue={setUsername} />
        <Input title="Email" width={400} error={warnings.email} setValue={setEmail} />
        <Input
          title="Password"
          width={400}
          ...
          type="password"
        />
        <Checkbox setChecked={setIsAdmin} checked={isAdmin} text="isAdmin" />
      </div>
