  ...
  return (
    <div className="profileCard">
      ...
      <div className="profileCard__buttons">
        <button className="profileCard__button edit" onClick={editClick} type="button">
          <span>edit</span>
          <svg
            width="18"
            height="19"
          ...
          >
            <path
              ...
              strokeLinecap="round"
            />
            <path d="M10.7003 3.14871L14.7409 7.18932" stroke="#4E4B66" strokeWidth="2" />
          </svg>
        </button>
        <button className="profileCard__button delete" onClick={deleteClick} type="button">
          <span>delete</span>
          <svg
            width="20"
            height="19"
          ...
          >
            ...
            <path
              ...
              strokeWidth="2"
            />
            <path d="M1.75 4.25H18.25" stroke="#4E4B66" strokeWidth="2" strokeLinecap="round" />
            <path d="M12.25 8.75V12.5" stroke="#4E4B66" strokeWidth="2" strokeLinecap="round" />
            <path d="M7.75 8.75V12.5" stroke="#4E4B66" strokeWidth="2" strokeLinecap="round" />
          </svg>
        </button>
      </div>
    </div>
