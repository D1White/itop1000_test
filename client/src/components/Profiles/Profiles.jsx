...
import plusIco from '../../assets/ico/plus.svg'

const Profiles = ({ setEditableProfile, userId }) => {
        ...
        <div className="profiles__content">
          ...
          {isLoading ? (
            ...
            <div className="profiles__block">
              ...
              <div className="profileCard add" onClick={createProfile} role="button" tabIndex={0}>
